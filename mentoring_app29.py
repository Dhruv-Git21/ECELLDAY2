...
# Load datasets
mentors = pd.read_csv("Mentors Slot 1 Day 2 - Sheet1.csv")  # Columns: Name, Sector 1, Sector 2, Sector 3, Index
startups = pd.read_csv("Startup Slot 1 Day 2 - Sheet1.csv")  # Columns: Name, Sector, Index, Contacts
